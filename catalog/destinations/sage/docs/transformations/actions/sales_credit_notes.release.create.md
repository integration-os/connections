### Create Sales Credit Notes Release

Releases a Sales Credit Notes.

[Documentation](https://developer.sage.com/accounting/reference/invoicing-sales/#tag/Sales-Credit-Notes/operation/postSalesCreditNotesKeyRelease)
