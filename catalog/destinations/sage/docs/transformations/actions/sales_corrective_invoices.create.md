### Create Sales Corrective Invoices

Creates corrective invoices for the selected sales invoices.

[Documentation](https://developer.sage.com/accounting/reference/invoicing-sales/#tag/Sales-Corrective-Invoices/operation/postSalesCorrectiveInvoices)
