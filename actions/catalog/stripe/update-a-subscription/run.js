...
const run = async (input) => {
  const {
    ...
    items1Tax_rates0,
    items1Tax_rates1,
    pause_collectionBehavior,
    pause_collectionResumes_at,
    ...
    const { data } = await axios({
      ...
      data: qs.stringify({
        ...
        ...(items0Billing_thresholdsUsage_gte
          ...
          : {}),
        ...(items0Clear_usage ? { "items[0][clear_usage]": items0Clear_usage } : {}),
        ...(items0Deleted ? { "items[0][deleted]": items0Deleted } : {}),
        ...(items0Id ? { "items[0][id]": items0Id } : {}),
        ...
        ...(items1Billing_thresholdsUsage_gte
          ...
          : {}),
        ...(items1Clear_usage ? { "items[1][clear_usage]": items1Clear_usage } : {}),
        ...(items1Deleted ? { "items[1][deleted]": items1Deleted } : {}),
        ...(items1Id ? { "items[1][id]": items1Id } : {}),
        ...
        ...(pause_collectionBehavior
          ? { "pause_collection[behavior]": pause_collectionBehavior }
          : {}),
        ...(pause_collectionResumes_at
          ? { "pause_collection[resumes_at]": pause_collectionResumes_at }
          : {}),
        ...(payment_settingsPayment_method_optionsAcss_debitMandate_optionsTransaction_type
          ? {
 ...
 */
const verifyInput = ({ BUILDABLE_STRIPE_SECRET_KEY, subscription_exposed_id }) => {
  const ERRORS = {
