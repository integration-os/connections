...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "post",
      url: `https://api.stripe.com/v1/test_helpers/treasury/outbound_transfers/${outbound_transfer}/return`,
      headers: {
      ...
      data: qs.stringify({
        ...
        ...(returned_detailsCode ? { "returned_details[code]": returned_detailsCode } : {}),
      }),
    });
