...
const run = async (input) => {
  const { BUILDABLE_STRIPE_SECRET_KEY, amount, currency, return_url, card, customer, expand } =
    input;
 ...
 */
const verifyInput = ({ BUILDABLE_STRIPE_SECRET_KEY, amount, currency, return_url }) => {
  const ERRORS = {
