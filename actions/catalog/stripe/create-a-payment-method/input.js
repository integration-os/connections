const nodeInput = ({ $body, $headers, $env, $data }) => {
  return {
    ...
    //   },
    // wechat_pay: {},
    // acss_debitAccount_number: "<string>",
    // acss_debitInstitution_number: "<string>",
    // acss_debitTransit_number: "<string>",
    // au_becs_debitAccount_number: "<string>",
    // au_becs_debitBsb_number: "<string>",
    // bacs_debitAccount_number: "<string>",
    // bacs_debitSort_code: "<string>",
    ...
    // fpxBank: "<string>",
    // idealBank: "<string>",
    // klarnaDobDay: "<integer>",
    // klarnaDobMonth: "<integer>",
    // klarnaDobYear: "<integer>",
    // p24Bank: "<string>",
    // radar_optionsSession: "<string>",
    // sepa_debitIban: "<string>",
    // sofortCountry: "<string>",
    // us_bank_accountAccount_holder_type: "<string>",
    // us_bank_accountAccount_number: "<string>",
    // us_bank_accountAccount_type: "<string>",
    // us_bank_accountFinancial_connections_account: "<string>",
    // us_bank_accountRouting_number: "<string>",
  };
};
