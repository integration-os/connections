...
const run = async (input) => {
  const {
    ...
    ownerName,
    ownerPhone,
    receiverRefund_attributes_method,
    redirectReturn_url,
  ...
  try {
    const { data } = await axios({
      ...
      data: qs.stringify({
        ...
        ...(receiverRefund_attributes_method
          ? { "receiver[refund_attributes_method]": receiverRefund_attributes_method }
          : {}),
        ...(redirectReturn_url ? { "redirect[return_url]": redirectReturn_url } : {}),
        ...(source_orderItems0Amount
