...
const run = async (input) => {
  const { BUILDABLE_STRIPE_SECRET_KEY, payment_method, customer, expand, expand0, expand1 } = input;
 ...
 */
const verifyInput = ({ BUILDABLE_STRIPE_SECRET_KEY, payment_method, customer }) => {
  const ERRORS = {
