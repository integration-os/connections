 ...
 */
const verifyInput = ({ BUILDABLE_PAGERDUTY_API_KEY, accept, contentType, from, incidents }) => {
  const ERRORS = {
    ...
    INVALID_INCIDENTS: "A valid incidents field (object) was not provided in the input.",
  };
  ...
  if (typeof incidents !== "object") throw new Error(ERRORS.INVALID_INCIDENTS);
};
