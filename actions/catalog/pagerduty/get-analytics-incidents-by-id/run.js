...
const run = async (input) => {
  const { BUILDABLE_PAGERDUTY_API_KEY, id, accept, contentType, xEARLYACCESS } = input;
 ...
 */
const verifyInput = ({ BUILDABLE_PAGERDUTY_API_KEY, id, accept, contentType, xEARLYACCESS }) => {
  const ERRORS = {
