...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, settings } = input;
 ...
 */
const verifyInput = ({ BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, settings }) => {
  const ERRORS = {
    ...
    INVALID_SETTINGS: "A valid settings field (string) was not provided in the input.",
  };
