...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, owner, repo, sarif_id } = input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_SARIF_ID: "A valid sarif_id field (string) was not provided in the input.",
  };
