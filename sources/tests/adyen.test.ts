...
const adyen = new AdyenIntegration({
  ADYEN_COMPANY_ID: process.env.ADYEN_COMPANY_ID,
  ADYEN_API_KEY: process.env.ADYEN_API_KEY,
  ADYEN_VERIFICATION_USERNAME: process.env.ADYEN_VERIFICATION_USERNAME,
  ADYEN_VERIFICATION_PASSWORD: process.env.ADYEN_VERIFICATION_PASSWORD,
});
