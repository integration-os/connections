 ...
 * Delete a File [Run]
 *
 * @description - Delete a File using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#delete-a-file
 *
 * ----------------------------------------------------------------------------------------------------
 */
 ...
 */
const verifyInput = ({ owner, repo, path, sha, message }) => {
  const ERRORS = {
