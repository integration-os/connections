/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Self-Hosted Runner Group for an Enterprise [Run]
 *
 * @description - Get a Self-Hosted Runner Group for an Enterprise using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#get-a-self-hosted-runner-group-for-an-enterprise
 *
 * ----------------------------------------------------------------------------------------------------
 */
