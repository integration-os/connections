/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Workflow Run Attempt [Run]
 *
 * @description - Get a workflow run attempt using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/actions#get-a-workflow-run-attempt
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_ATTEMPT_NUMBER:
      "A valid attempt_number field (number) was not provided in the input.",
  };
  ...
  if (typeof attempt_number !== "number")
    throw new Error(ERRORS.INVALID_ATTEMPT_NUMBER);
};
