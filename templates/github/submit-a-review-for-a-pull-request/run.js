/**
 * ----------------------------------------------------------------------------------------------------
 * Submit a Review for a Pull Request [Run]
 *
 * @description - Submit a Review for a Pull Request using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/pulls#submit-a-review-for-a-pull-request
 *
 * ----------------------------------------------------------------------------------------------------
 */
 ...
 */
const verifyInput = ({ owner, repo, pull_number, review_id, event }) => {
  const ERRORS = {
    ...
    INVALID_EVENT: "A valid event field (string) was not provided in the input.",
  };
  ...
  if (typeof event !== "string") throw new Error(ERRORS.INVALID_EVENT);
};
