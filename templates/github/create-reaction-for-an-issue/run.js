/**
 * ----------------------------------------------------------------------------------------------------
 * Create Reaction for an Issue [Run]
 *
 * @description - Create Reaction for an Issue using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/reactions#create-reaction-for-an-issue
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, owner, repo, issue_number, content } = input;
 ...
 */
const verifyInput = ({ owner, repo, issue_number, content }) => {
  const ERRORS = {
