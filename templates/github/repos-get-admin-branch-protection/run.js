/**
 * ----------------------------------------------------------------------------------------------------
 * Get Admin Branch Protection [Run]
 *
 * @description - Get admin branch protection using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#get-admin-branch-protection
 *
 * ----------------------------------------------------------------------------------------------------
 */
