...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, owner, repo, tree, base_tree } =
    input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_TREE: "A valid tree field (object) was not provided in the input.",
  };
  ...
  if (typeof tree !== "object") throw new Error(ERRORS.INVALID_TREE);
};
