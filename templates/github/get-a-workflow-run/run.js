/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Workflow Run [Run]
 *
 * @description - Get a Workflow Run using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/actions#get-a-workflow-run
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, owner, repo, run_id, exclude_pull_requests } =
    input;
