/**
 * ----------------------------------------------------------------------------------------------------
 * Create a Project Card [Run]
 *
 * @description - Create a project card using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/projects#create-a-project-card
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, column_id, note } = input;
