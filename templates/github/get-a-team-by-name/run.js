/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Team by Name [Run]
 *
 * @description - Get a Team by Name using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-team-by-name
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, org, team_slug } = input;
