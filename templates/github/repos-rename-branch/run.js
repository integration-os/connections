 ...
 * Rename a Branch [Run]
 *
 * @description - Rename a branch using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#rename-a-branch
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_NEW_NAME:
      "A valid new_name field (string) was not provided in the input.",
  };
