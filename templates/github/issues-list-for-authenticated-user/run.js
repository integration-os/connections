/**
 * ----------------------------------------------------------------------------------------------------
 * List User Account Issues Assigned to the Authenticated User [Run]
 *
 * @description - List user account issues assigned to the authenticated user using the Github API
 *
