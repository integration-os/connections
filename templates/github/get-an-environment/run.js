/**
 * ----------------------------------------------------------------------------------------------------
 * Get an Environment [Run]
 *
 * @description - Get an Environment using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#get-an-environment
 *
 * ----------------------------------------------------------------------------------------------------
 */
