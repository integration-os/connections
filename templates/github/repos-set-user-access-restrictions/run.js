...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, owner, repo, branch, users } =
    input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_USERS: "A valid users field (object) was not provided in the input.",
  };
