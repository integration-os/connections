/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Self-Hosted Runner for an Enterprise [Run]
 *
 * @description - Get a self-hosted runner for an enterprise using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#get-a-self-hosted-runner-for-an-enterprise
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, enterprise, runner_id } =
    input;
