...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, token_id } = input;
 ...
 */
const verifyInput = ({ GITHUB_API_TOKEN, GITHUB_API_USERNAME, token_id }) => {
  const ERRORS = {
    ...
    INVALID_TOKEN_ID:
      "A valid token_id field (number) was not provided in the input.",
  };
