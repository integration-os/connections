/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Repository Secret [Run]
 *
 * @description - Get a repository secret using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/actions#get-a-repository-secret
 *
 * ----------------------------------------------------------------------------------------------------
 */
