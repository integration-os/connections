/**
 * ----------------------------------------------------------------------------------------------------
 * Create a Project Column [Run]
 *
 * @description - Create a Project Column using the GitHub API
 *
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, project_id, name } = input;
 ...
 */
const verifyInput = ({ project_id, name }) => {
  const ERRORS = {
