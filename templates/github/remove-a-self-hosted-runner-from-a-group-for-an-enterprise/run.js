/**
 * ----------------------------------------------------------------------------------------------------
 * Remove a Self-Hosted Runner From a Group for an Enterprise [Run]
 *
 * @description - Remove a Self-Hosted Runner From a Group for an Enterprise using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#remove-a-self-hosted-runner-from-a-group-for-an-enterprise
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, enterprise, runner_group_id, runner_id } = input;
 ...
 */
const verifyInput = ({ enterprise, runner_group_id, runner_id }) => {
  const ERRORS = {
