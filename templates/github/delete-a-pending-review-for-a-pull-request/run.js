/**
 * ----------------------------------------------------------------------------------------------------
 * Delete a Pending Review for a Pull Request [Run]
 *
 * @description - Delete a Pending Review for a Pull Request using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/pulls#delete-a-pending-review-for-a-pull-request
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, owner, repo, pull_number, review_id } = input;
