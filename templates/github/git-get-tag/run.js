...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, owner, repo, tag_sha } = input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_TAG_SHA: "A valid tag_sha field (string) was not provided in the input.",
  };
