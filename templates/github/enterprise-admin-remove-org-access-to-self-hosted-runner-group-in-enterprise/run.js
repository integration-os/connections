/**
 * ----------------------------------------------------------------------------------------------------
 * Remove Organization Access to a Self-Hosted Runner Group in an Enterprise [Run]
 *
 * @description - Remove organization access to a self-hosted runner group in an enterprise using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#remove-organization-access-to-a-self-hosted-runner-group-in-an-enterprise
 *
 * ----------------------------------------------------------------------------------------------------
 */
