...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, key_ids } = input;
 ...
 */
const verifyInput = ({ GITHUB_API_TOKEN, GITHUB_API_USERNAME, key_ids }) => {
  const ERRORS = {
    ...
    INVALID_KEY_IDS:
      "A valid key_ids field (string) was not provided in the input.",
  };
