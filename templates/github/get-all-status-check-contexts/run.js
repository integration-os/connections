/**
 * ----------------------------------------------------------------------------------------------------
 * Get All Status Check Contexts [Run]
 *
 * @description - Get All Status Check Contexts using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#get-all-status-check-contexts
 *
 * ----------------------------------------------------------------------------------------------------
 */
