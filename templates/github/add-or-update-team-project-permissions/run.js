/**
 * ----------------------------------------------------------------------------------------------------
 * Add or Update Team Project Permissions [Run]
 *
 * @description - Add or Update Team Project Permissions using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-project-permissions
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, org, team_slug, project_id, permission } = input;
 ...
 */
const verifyInput = ({ org, team_slug, project_id }) => {
  const ERRORS = {
