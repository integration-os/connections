/**
 * ----------------------------------------------------------------------------------------------------
 * Set Organization Access for a Self-Hosted Runner Group in an Enterprise [Run]
 *
 * @description - Set Organization Access for a Self-Hosted Runner Group in an Enterprise using the GitHub API
 *
 ...
 */
const verifyInput = ({ enterprise, runner_group_id, selected_organization_ids }) => {
  const ERRORS = {
