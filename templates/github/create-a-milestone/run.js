/**
 * ----------------------------------------------------------------------------------------------------
 * Create a Milestone [Run]
 *
 * @description - Create a Milestone using the GitHub API
 *
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, owner, repo, title, state, description, due_on } =
    input;
 ...
 */
const verifyInput = ({ owner, repo, title }) => {
  const ERRORS = {
