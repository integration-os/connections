/**
 * ----------------------------------------------------------------------------------------------------
 * List Branches for HEAD Commit [Run]
 *
 * @description - List branches for head commit using the Github API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/repos#list-branches-for-head-commit
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, owner, repo, commit_sha } =
    input;
