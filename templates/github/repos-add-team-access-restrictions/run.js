...
const run = async (input) => {
  const { BUILDABLE_GITHUB_ACCESS_TOKEN, BUILDABLE_GITHUB_ACCOUNT_USERNAME, owner, repo, branch, teams } =
    input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_TEAMS: "A valid teams field (object) was not provided in the input.",
  };
