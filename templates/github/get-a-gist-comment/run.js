/**
 * ----------------------------------------------------------------------------------------------------
 * Get a Gist Comment [Run]
 *
 * @description - Get a Gist Comment using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/gists#get-a-gist-comment
 *
 * ----------------------------------------------------------------------------------------------------
 */
