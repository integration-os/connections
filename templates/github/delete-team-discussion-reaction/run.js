/**
 * ----------------------------------------------------------------------------------------------------
 * Delete Team Discussion Reaction [Run]
 *
 * @description - Delete Team Discussion Reaction using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/reactions#delete-team-discussion-reaction
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, org, team_slug, discussion_number, reaction_id } =
    input;
  ...
  try {
    const { data } = await axios({
      method: "delete",
      url: `https://api.github.com/orgs/${org}/teams/${team_slug}/discussions/${discussion_number}/reactions/${reaction_id}`,
 ...
 */
const verifyInput = ({ org, team_slug, discussion_number, reaction_id }) => {
  const ERRORS = {
