...
const run = async (input) => {
  const { GITHUB_API_TOKEN, GITHUB_API_USERNAME, app_slug } = input;
 ...
 */
const verifyInput = ({ GITHUB_API_TOKEN, GITHUB_API_USERNAME, app_slug }) => {
  const ERRORS = {
    ...
    INVALID_APP_SLUG:
      "A valid app_slug field (string) was not provided in the input.",
  };
