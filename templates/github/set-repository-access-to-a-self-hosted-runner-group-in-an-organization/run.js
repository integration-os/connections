/**
 * ----------------------------------------------------------------------------------------------------
 * Set Repository Access for a Self-Hosted Runner Group in an Organization [Run]
 *
 * @description - Set Repository Access for a Self-Hosted Runner Group in an Organization using the GitHub API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://docs.github.com/enterprise-server@3.3/rest/reference/actions#set-repository-access-to-a-self-hosted-runner-group-in-an-organization
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { GITHUB_API_USERNAME, GITHUB_API_TOKEN, org, runner_group_id, selected_repository_ids } =
    input;
 ...
 */
const verifyInput = ({ org, runner_group_id, selected_repository_ids }) => {
  const ERRORS = {
