 ...
 * Create a Commit [Run]
 *
 * @description - Create a Commit using the GitHub API
 *
 ...
 */
const verifyInput = ({ owner, repo, tree, message }) => {
  const ERRORS = {
    INVALID_OWNER: "A valid owner field (string) was not provided in the input.",
    INVALID_REPO: "A valid repo field (string) was not provided in the input.",
    INVALID_TREE: "A valid tree field (string) was not provided in the input.",
    INVALID_MESSAGE: "A valid message field (string) was not provided in the input.",
  };

  if (typeof owner !== "string") throw new Error(ERRORS.INVALID_OWNER);
  if (typeof repo !== "string") throw new Error(ERRORS.INVALID_REPO);
  if (typeof tree !== "string") throw new Error(ERRORS.INVALID_TREE);
