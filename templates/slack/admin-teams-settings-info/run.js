/**
 * ----------------------------------------------------------------------------------------------------
 * Fetch Information About Settings in a Workspace [Run]
 *
 * @description - Fetch information about settings in a workspace using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.teams.settings.info
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, team_id } = input;
