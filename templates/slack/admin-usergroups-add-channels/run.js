/**
 * ----------------------------------------------------------------------------------------------------
 * Add One or More Default Channels to an IDP Group. [Run]
 *
 * @description - Add one or more default channels to an idp group. using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.usergroups.addChannels
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, channel_ids, usergroup_id, team_id } = input;
 ...
 */
const verifyInput = ({ SLACK_ACCESS_TOKEN, channel_ids, usergroup_id }) => {
  const ERRORS = {
