/**
 * ----------------------------------------------------------------------------------------------------
 * Manually Sets User Presence. [Run]
 *
 * @description - Manually sets user presence. using the Slack API
 *
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, presence } = input;
 ...
 */
const verifyInput = ({ SLACK_ACCESS_TOKEN, presence }) => {
  const ERRORS = {
