/**
 * ----------------------------------------------------------------------------------------------------
 * List All IDP Groups Linked to a Channel [Run]
 *
 * @description - List all idp groups linked to a channel using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.conversations.restrictAccess.listGroups
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, channel_id, team_id } = input;
