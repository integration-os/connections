/**
 * ----------------------------------------------------------------------------------------------------
 * Set the Posting Permissions for a Public or Private Channel. [Run]
 *
 * @description - Set the posting permissions for a public or private channel. using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.conversations.setConversationPrefs
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, channel_id, prefs } = input;
 ...
 */
const verifyInput = ({ SLACK_ACCESS_TOKEN, channel_id, prefs }) => {
  const ERRORS = {
