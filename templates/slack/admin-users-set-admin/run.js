/**
 * ----------------------------------------------------------------------------------------------------
 * Set an Existing Guest, Regular User, or Owner to Be an Admin User. [Run]
 *
 * @description - Set an existing guest, regular user, or owner to be an admin user. using the Slack API
 *
