/**
 * ----------------------------------------------------------------------------------------------------
 * Set an Existing Guest User, Admin User, or Owner to Be a Regular User. [Run]
 *
 * @description - Set an existing guest user, admin user, or owner to be a regular user. using the Slack API
 *
