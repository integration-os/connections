/**
 * ----------------------------------------------------------------------------------------------------
 * Set the User Profile Photo [Run]
 *
 * @description - Set the user profile photo using the Slack API
 *
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, token, crop_w, crop_x, crop_y, image } = input;
