/**
 * ----------------------------------------------------------------------------------------------------
 * Find a User with an Email Address. [Run]
 *
 * @description - Find a user with an email address. using the Slack API
 *
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, email } = input;
 ...
 */
const verifyInput = ({ SLACK_ACCESS_TOKEN, email }) => {
  const ERRORS = {
