/**
 * ----------------------------------------------------------------------------------------------------
 * Delete a Public or Private Channel. [Run]
 *
 * @description - Delete a public or private channel. using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.conversations.delete
 *
 * ----------------------------------------------------------------------------------------------------
 */
