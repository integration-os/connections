/**
 * ----------------------------------------------------------------------------------------------------
 * Add an Enterprise User to a Workspace. [Run]
 *
 * @description - Add an enterprise user to a workspace. using the Slack API
 *
...
const run = async (input) => {
  const { SLACK_ACCESS_TOKEN, team_id, user_id, channel_ids, is_restricted, is_ultra_restricted } =
    input;
