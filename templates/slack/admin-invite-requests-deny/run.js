/**
 * ----------------------------------------------------------------------------------------------------
 * Deny a Workspace Invite Request. [Run]
 *
 * @description - Deny a workspace invite request. using the Slack API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://api.slack.com/methods/admin.inviteRequests.deny
 *
 * ----------------------------------------------------------------------------------------------------
 */
