...
const run = async (input) => {
  const { TATUM_API_URL, TATUM_API_KEY, to, fromUTXO, changeAddress, fee } =
    input;
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_CHANGE_ADDRESS:
      "A valid changeAddress field (string) was not provided in the input.",
  ...
  if (typeof changeAddress !== "string")
    throw new Error(ERRORS.INVALID_CHANGE_ADDRESS);
