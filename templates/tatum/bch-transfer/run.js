/**
 * ----------------------------------------------------------------------------------------------------
 * Send Bitcoin Cash From Tatum Account to Address [Run]
 *
 * @description - Send bitcoin cash from tatum account to address using the Tatum API
 *
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "post",
      url: `${TATUM_API_URL}/v3/offchain/bcash/transfer`,
