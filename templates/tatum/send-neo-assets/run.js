...
const run = async (input) => {
  const { TATUM_API_URL, TATUM_API_KEY, fromPrivateKey, assets, to } = input;
 ...
 */
const verifyInput = ({ TATUM_API_KEY, TATUM_API_URL, fromPrivateKey, assets, to }) => {
  const ERRORS = {
