/**
 * ----------------------------------------------------------------------------------------------------
 * Send LYRA to Blockchain Addresses [Run]
 *
 * @description - Send lyra to blockchain addresses using the Tatum API
 *
...
const run = async (input) => {
  const { TATUM_API_URL, TATUM_API_KEY, to, fromAddress, fromUTXO } = input;
 ...
 */
const verifyInput = ({ TATUM_API_KEY, TATUM_API_URL, to }) => {
  const ERRORS = {
