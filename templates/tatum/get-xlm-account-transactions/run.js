/**
 * ----------------------------------------------------------------------------------------------------
 * Get XLM Account Transactions [Run]
 *
 * @description - Get xlm account transactions using the Tatum API
 *
...
const run = async (input) => {
  const { TATUM_API_URL, TATUM_API_KEY, account, pagination } = input;
