/**
 * ----------------------------------------------------------------------------------------------------
 * Get Litecoin UTXO of Transaction [Run]
 *
 * @description - Get litecoin utxo of transaction using the Tatum API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://tatum.io/apidoc.php#operation/LtcGetUTXO
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "get",
      url: `${TATUM_API_URL}/v3/litecoin/utxo/${hash}/${index}`,
