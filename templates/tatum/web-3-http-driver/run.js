...
const run = async (input) => {
  const { TATUM_API_URL, id, params, method, jsonrpc, xApiKey, quorumEndpoint } = input;
 ...
 */
const verifyInput = ({ quorumEndpoint, TATUM_API_URL, xApiKey, id, params, method, jsonrpc }) => {
  const ERRORS = {
