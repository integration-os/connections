/**
 * ----------------------------------------------------------------------------------------------------
 * Deploy Kcs ERC20 Smart Contract to Blockchain and Ledger [Run]
 *
 * @description - Deploy kcs erc20 smart contract to blockchain and ledger using the Tatum API
 *
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "post",
      url: `${TATUM_API_URL}/v3/offchain/kcs/erc20/deploy`,
