...
const nodeInput = ({ $trigger, $nodes }) => {
  return {
    ...
    mnemonic: `artist alarm clerk obscure timber firm reopen provide ankle vicious exhibit waste math toilet believe puppy lucky coast post kind black suspect mule able market`, // Required
