/**
 * ----------------------------------------------------------------------------------------------------
 * Update NFT Auction Fee Recipient [Run]
 *
 * @description - Update nft auction fee recipient using the Tatum API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://tatum.io/apidoc.php#operation/UpdateAuctionFeeRecipient
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "put",
      url: `${TATUM_API_URL}/v3/blockchain/auction/recipient`,
