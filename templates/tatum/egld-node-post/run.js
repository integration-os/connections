...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_VERSION:
      "A valid version field (number) was not provided in the input.",
    INVALID_CHAIN_ID:
      "A valid chainId field (string) was not provided in the input.",
    INVALID_NONCE:
      "A valid nonce field (number) was not provided in the input.",
    INVALID_VALUE:
      "A valid value field (string) was not provided in the input.",
    INVALID_RECEIVER:
      "A valid receiver field (string) was not provided in the input.",
    INVALID_SENDER:
      "A valid sender field (string) was not provided in the input.",
    INVALID_GAS_PRICE:
      "A valid gasPrice field (number) was not provided in the input.",
    INVALID_GAS_LIMIT:
      "A valid gasLimit field (number) was not provided in the input.",
    INVALID_DATA: "A valid data field (string) was not provided in the input.",
    INVALID_SIGNATURE:
      "A valid signature field (string) was not provided in the input.",
  };
