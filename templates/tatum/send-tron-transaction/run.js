...
const run = async (input) => {
  const { TATUM_API_URL, TATUM_API_KEY, amount, to, fromPrivateKey } = input;
 ...
 */
const verifyInput = ({ TATUM_API_KEY, TATUM_API_URL, amount, to, fromPrivateKey }) => {
  const ERRORS = {
