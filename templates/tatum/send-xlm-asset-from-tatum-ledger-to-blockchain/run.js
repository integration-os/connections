/**
 * ----------------------------------------------------------------------------------------------------
 * Send XLM / Asset From Tatum Ledger to Blockchain [Run]
 *
 * @description - Send xlm / asset from tatum ledger to blockchain using the Tatum API
 *
...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_SECRET:
      "A valid secret field (string) was not provided in the input.",
    INVALID_AMOUNT:
