/**
 * ----------------------------------------------------------------------------------------------------
 * Deploy BSC BEP20 Smart Contract to Blockchain and Ledger [Run]
 *
 * @description - Deploy bsc bep20 smart contract to blockchain and ledger using the Tatum API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://tatum.io/apidoc.php#operation/BscDeployBep20
 *
 * ----------------------------------------------------------------------------------------------------
 */
