...
const verifyInput = ({
  ...
  const ERRORS = {
    ...
    INVALID_AMOUNT:
      "A valid amount field (number) was not provided in the input.",
    INVALID_NUM_OF_DECIMALS:
      "A valid numOfDecimals field (number) was not provided in the input.",
  };
  ...
  if (typeof numOfDecimals !== "number")
    throw new Error(ERRORS.INVALID_NUM_OF_DECIMALS);
};
