/**
 * ----------------------------------------------------------------------------------------------------
 * Get Information About The User's Current Playback [Run]
 *
 * @description - Get information about the user's current playback using the Spotify API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://developer.spotify.com/documentation/web-api/reference/#endpoint-get-information-about-the-users-current-playback
 *
 * ----------------------------------------------------------------------------------------------------
 */
 ...
 */
const verifyInput = ({ SPOTIFY_CLIENT_ID, SPOTIFY_CLIENT_SECRET, SPOTIFY_BASE_URI }) => {
  const ERRORS = {
