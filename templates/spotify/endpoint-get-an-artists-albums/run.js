/**
 * ----------------------------------------------------------------------------------------------------
 * Get an Artist's Albums [Run]
 *
 * @description - Get an artist's albums using the Spotify API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://developer.spotify.com/documentation/web-api/reference/#endpoint-get-an-artists-albums
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  ...
  try {
    ...
    const { data } = await axios({
      method: "get",
      url: `${SPOTIFY_BASE_URI}/artists/${id}/albums`,
      headers: {
