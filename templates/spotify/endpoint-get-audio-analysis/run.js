/**
 * ----------------------------------------------------------------------------------------------------
 * Get Audio Analysis for a Track [Run]
 *
 * @description - Get audio analysis for a track using the Spotify API
 *
 * @author    Buildable Technologies Inc.
 * @access    open
 * @license   MIT
 * @docs      https://developer.spotify.com/documentation/web-api/reference/#endpoint-get-audio-analysis
 *
 * ----------------------------------------------------------------------------------------------------
 */
...
const run = async (input) => {
  ...
  try {
    ...
    const { data } = await axios({
      method: "get",
      url: `${SPOTIFY_BASE_URI}/audio-analysis/${id}`,
      headers: {
