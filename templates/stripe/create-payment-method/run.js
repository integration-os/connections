/**
 * ----------------------------------------------------------------------------------------------------
 * Create a Payment Method [Run]
 *
 * @description - Create a Payment Method using the Stripe API
 *
...
const run = async (input) => {
  const { STRIPE_SECRET_KEY, type, ...params } = input;
 ...
 */
const verifyInput = ({ STRIPE_SECRET_KEY, type }) => {
  const ERRORS = {
