/**
 * ----------------------------------------------------------------------------------------------------
 * Reopen Closed Order [Run]
 *
 * @description - Reopen a closed order using the Shopify API
 *
...
const getPath = (orderId) => `orders/${orderId}/open`;
...
const run = async (input) => {
  const { ACCESS_TOKEN, STORE_URL, orderId } = input;
