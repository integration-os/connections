/**
 * ----------------------------------------------------------------------------------------------------
 * Get a User's Pinned Lists [Run]
 *
 * @description - Get a user's pinned lists using the Twitter API
 *
...
const run = async (input) => {
  const { TWITTER_BEARER_TOKEN, id, listFields, expansions, userFields } =
    input;
