/**
 * ----------------------------------------------------------------------------------------------------
 * Returns User Objects that Are Blocked by Provided User ID [Run]
 *
 * @description - Returns user objects that are blocked by provided user id using the Twitter API
 *
