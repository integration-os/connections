 ...
 * Login User [Run]
 *
 * @description - Login a user using the Supabase Auth Service
 *
...
const run = async (input) => {
  const { SUPABASE_URL, SUPABASE_KEY, email, password, ...params } = input;
 ...
 */
const verifyInput = ({ SUPABASE_URL, SUPABASE_KEY, email, password }) => {
