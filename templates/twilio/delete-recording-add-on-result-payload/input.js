/**
 * ----------------------------------------------------------------------------------------------------
 * Delete Recording Add on Result Payload [Input]
 *
...
const nodeInput = ({ $trigger, $nodes }) => {
  return {
    ...
    referenceSid: "stringstringstringstringstringstri", // Required
    addOnResultSid: "stringstringstringstringstringstri", // Required
