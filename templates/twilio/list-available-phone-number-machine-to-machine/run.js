/**
 * ----------------------------------------------------------------------------------------------------
 * List Available Phone Number Machine to Machine [Run]
 *
 * @description -
 *
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "get",
      url: `https://api.twilio.com/2010-04-01/Accounts/${TWILIO_ACCOUNT_SID}/AvailablePhoneNumbers/${countryCode}/MachineToMachine.json`,
