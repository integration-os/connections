/**
 * ----------------------------------------------------------------------------------------------------
 * Delete Sip Auth Calls Credential List Mapping [Run]
 *
...
const run = async (input) => {
  ...
  try {
    const { data } = await axios({
      method: "delete",
      url: `https://api.twilio.com/2010-04-01/Accounts/${TWILIO_ACCOUNT_SID}/SIP/Domains/${domainSid}/Auth/Calls/CredentialListMappings/${sid}.json`,
