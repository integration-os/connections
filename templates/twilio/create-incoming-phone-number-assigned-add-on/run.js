/**
 * ----------------------------------------------------------------------------------------------------
 * Create Incoming Phone Number Assigned Add On [Run]
 *
...
const run = async (input) => {
  const { TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, resourceSid, installedAddOnSid } = input;
 ...
 */
const verifyInput = ({ TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, resourceSid, installedAddOnSid }) => {
  const ERRORS = {
