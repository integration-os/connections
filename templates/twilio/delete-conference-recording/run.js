/**
 * ----------------------------------------------------------------------------------------------------
 * Delete Conference Recording [Run]
 *
...
const run = async (input) => {
  const { TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, conferenceSid, sid } = input;
 ...
 */
const verifyInput = ({ TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, conferenceSid, sid }) => {
  const ERRORS = {
